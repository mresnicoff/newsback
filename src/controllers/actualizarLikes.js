const { Noticia } = require("../db.js"); // Asegúrate de que el modelo 'Noticia' esté correctamente definido en tu archivo db.js
...
const actualizarLikes = async (req, res) => {
  if (req.method === "POST") {
    try {
      ...
      await noticia.update({ likes: likesActualizados });
